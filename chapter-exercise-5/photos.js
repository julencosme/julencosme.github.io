...
function populateFigures() {
  ...
  if (figureCount === 3) {
    for (var i = 1; i < 4; i++) {
      // set value of filename variable using corresponding value in photoOrder array
      filename = "images/IMG_0" + photoOrder[i] + "sm.jpg";
      // reference element corresponding to one less than counter variable value
      currentFig = document.getElementsByTagName("img")[i - 1];
      // assign value of filename to src attribute of img element
...
function previewFive() {
  ...
  // use appendChild() method to add firstFigure node to document tree
