...
var lodging = [];       // lodging array
var objectString;       // parse string
var arrayString;        // parse string
...
//   if (unInput.value.length < 4) {
    ...
    // specify for any character to repeat at least 4 times
...
//    if ( // check for presence of "@" character
//        (/@/.test(emailInput.value) === false) || (
//          // test to ensure domain is of standard length (i.e., 2,3,4 or 6 characters)
//          (/\...$/.test(emailInput.value) === false) &&
//          (/\....$/.test(emailInput.value) === false) &&
//          (/\.....$/.test(emailInput.value) === false) &&
//          (/\......$/.test(emailInput.value) === false)
...
function convertToString() {
  // convert lodgings array to string
